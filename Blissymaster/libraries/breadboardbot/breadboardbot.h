...
const float tireDiam = 2.5; // inches.  N.B. The units here determine units
const float trackWidth = 8.75; // inches      used everywhere for distance
...
float duration_per_distance( float distance, byte speed) {
  ...
  float dist_per_sec = (0.1488 * float(speed)) - 1.4776;// in inches, from data
